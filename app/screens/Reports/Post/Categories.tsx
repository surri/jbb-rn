...
type Props = {
    navigation: StackNavigationProp<ReportsNavigatorParams, 'Categories'>,
    route: RouteProp<ReportsNavigatorParams, 'Categories'>
}

const Categories: React.FC<Props> = ({ navigation, route }:Props) => {
